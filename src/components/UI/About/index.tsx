  ...
  return (
    <AboutWrapper>
      <AboutContent>
        ...
        <AboutText>
          <span style={{color: 'var(--primaryOrange)'}} id="about">hasabTech</span> is a small but ambitious software studio focused on building meaningful digital products and scalable solutions along with giving back to the tech community. 
