...
// For desktop
export const desktopHeaderPhrase = ["We are currently intaking", 'registrations for the upcoming batch'];
...
// For mobile
export const mobileHeaderPhrase = ["We are currently", 'intaking registrations for the upcoming batch'];
