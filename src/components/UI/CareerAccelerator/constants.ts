...
// For desktop
export const desktopHeaderPhrase = ["What's inside the Career Accelerator?"];
export const desktopParagraphPhrase = [
  'Our Career Accelerator Program helps you become a job-ready engineer.',
  "From Zero to Junior Level Engineer, we guide you through the journey.",
];
